  ...
  public function executeIndex(sfWebRequest $request) {
    try {
      ...
      if ($this->md_order && $this->md_order->isOrderValid()) {
        ...
        $this->llavePublicaCifrado = file_get_contents(sfConfig::get('sf_data_dir') . '/visa/' . sfConfig::get('app_visanet_ENVIRONMENT') . '/ALIGNET.PRODUCCION.PHP.CRYPTO.PUBLIC.txt');
  ...
  public function executeProcess(sfWebRequest $request) {
    if ($request->isMethod('POST')) {
      try {
        ...
        $llavePublicaFirma = file_get_contents(sfConfig::get('sf_data_dir') . '/visa/' . sfConfig::get('app_visanet_ENVIRONMENT') . '/ALIGNET.PRODUCCION.PHP.SIGNATURE.PUBLIC.txt');
